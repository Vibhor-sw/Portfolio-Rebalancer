...
export const userHoldings: Fund[] = [
  ...
  {
    id: 'h7',
    fundName: 'UTI Flexi Cap Fund - Direct Growth',
    subCategory: 'Flexi Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 1,
  ...
  {
    id: 'h9',
    fundName: 'Quant Infrastructure Fund - Direct Growth',
  ...
  {
    id: 'h10',
    fundName: 'Navi US Total Stock Market FoF - Direct Growth',
...
export const fundUniverse: Fund[] = [
  // Small Cap replacements (for h6 replacement)
  {
    id: 'u1',
  ...
  {
    id: 'u2',
    fundName: 'HDFC Small Cap Fund - Direct Growth',
    subCategory: 'Small Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 5,
  ...
  {
    id: 'u3',
    fundName: 'Canara Robeco Small Cap Fund - Direct Growth',
    subCategory: 'Small Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 4,
  ...
  {
    id: 'u5',
    fundName: 'PGIM India Flexi Cap Fund - Direct Growth',
    subCategory: 'Flexi Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 5,
  ...
  {
    id: 'u6',
    fundName: 'JM Flexi Cap Fund - Direct Growth',
    subCategory: 'Flexi Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 4,
  ...
  {
    id: 'u7',
    fundName: 'Quant Mid Cap Fund - Direct Growth',
    subCategory: 'Mid Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 5,
  ...
  {
    id: 'u11',
    fundName: 'DSP Small Cap Fund - Direct Growth',
    subCategory: 'Small Cap',
    option: 'Growth',
    plan: 'Direct',
    geojitRating: 3,
